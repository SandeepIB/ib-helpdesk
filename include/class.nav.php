...
class StaffNav {
    ...
    function getTabs(){
        ...
        if(!isset($this->tabs)) {
            ...
            $this->tabs['sla']=array('desc'=>__('SLA'),'href'=>'sla.php','title'=>__('SLA'));
...
class UserNav {
    ...
    function getNavLinks(){
        ...
        if(!$this->navs){
            ...
            if($user && $user->isValid() && !$user->isGuest()) {
            $navs['sla']=array('desc'=>__('SLA'),'href'=>'sla.php','title'=>'');
            #$navs['mediclaim_doc']=array('desc'=>__('Mediclaim'),'href'=>'mediclaim_document.php','title'=>'');
        }
            $this->navs=$navs;
        }
        return $this->navs;
