            ...
            <p>
             <?php
                if ($thisclient && is_object($thisclient) && $thisclient->isValid()
                 ...
                 ?>
                <a href="<?php echo ROOT_PATH; ?>profile.php" class="linkfontcolor"><?php echo __('Profile'); ?></a> |
                <a href="<?php echo ROOT_PATH; ?>tickets.php" class="linkfontcolor"><?php echo sprintf(__('Tickets <b>(%d)</b>'), $thisclient->getNumTickets()); ?></a> -
                <a href="<?php echo $signout_url; ?>" class="linkfontcolor"><?php echo __('Sign Out'); ?></a>
            <?php
            } elseif($nav) {
                ...
                elseif ($cfg->getClientRegistrationMode() != 'disabled') { ?>
                    <a href="<?php echo $signin_url; ?>" class="blue button "><?php echo __('Sign In'); ?></a>
<?php
                }
            } ?>
            </p>
...
<?php }
        ...
        <?php
        if($nav){ ?>
        <ul id="nav" class="flush-left client-flush-left">
            <?php
