...
if ($content) {
    ...
    $title = __('Sign In');
    $body = __('Kindly sign in using your InfoBeans email ID to create a new ticket.');
}

?>
<h1 class="dark-heading-h1"><?php echo Format::display($title); ?></h1>
...
if ($cfg && $cfg->isClientRegistrationEnabled()) {
    if (count($ext_bks)) echo '<hr style="width:100%"/>'; ?>
...
<?php } ?>
    ...
    <a href="<?php echo ROOT_PATH; ?>scp/" class="linkfontcolor"><?php echo __('Sign in here'); ?></a>
    </div>
    </div>
</div>
</form>
