...
<form action="tickets.php" method="get" id="ticketSearchForm">
    ...
    <input type="text" class="searchBox" name="keywords" size="30" value="<?php echo Format::htmlchars($settings['keywords']); ?>">
    <input type="submit" value="<?php echo __('Search');?>">
<div class="pull-right">
    <?php echo __('Help Topic'); ?>:
    <select name="topic_id" class="nowarn filter-topics" onchange="javascript: this.form.submit(); ">
