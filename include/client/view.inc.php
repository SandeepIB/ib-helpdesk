...
<table width="100%" cellpadding="1" cellspacing="0" border="0" id="ticketInfo">
    <tr>
        ...
        <div class="d-flex">
            ...
            <div class="pull-right-edit-print">
...
<?php } ?>
    ...
    <tr>
        <td width="50%">
            <table class="infoTable tableHeadingDark" cellspacing="1" cellpadding="3" width="100%" border="0">
                <thead>
...
<table class="infoTable tableHeadingDark" cellspacing="1" cellpadding="3" width="50%" border="0">
                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $ticket->getSLA(); ?></td>
                                    </tr>
                                    <tr>
                                        <th><?php echo __('Due Date');?>:</th>
                                        <td><?php echo $ticket->getCustomEstDueDate(); ?></td>
                                    </tr>
                </tbody>
            </table>
<br>
