...
define('SECRET_SALT','ZYB54PaM=GbCRviJFJlXCYvbtyTJ7WQ2');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','priyanka.attarde@outlook.com');
...
define('DBNAME','helpdeskqa2');
define('DBUSER','root');
#define('DBPASS','tD:wgkZao6(1');
define('DBPASS','Root@1234');
